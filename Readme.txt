• I used bootstrap and react components to build the website.
• I setuped react router dom for routing.
• Fetched data from api link given in github repo of ProgrammingHero1
• Quiz topics been loaded in root page then after clicking any quiz topic we will get an id of that topic.
